...
\begin{tikzpicture}[x=1pt, y=1pt, outer sep=0pt,
  ...
  \draw[flow, rounded corners=3pt] ($(bin)+(-4pt,0)$) -- ++(-92pt,0) |- ([yshift=-5pt]p1.west);
  \foreach \p/\q in {p1/p2, p2/p3, p3/p4, p4/p5, p5/p6}
    \draw[flow, rounded corners=3pt] (\p.west) -- ++(-88pt,0) |- ([yshift=-5pt]\q.west);
  \draw[flow, rounded corners=3pt] (p6.west) -- ++(-88pt,0) |- (p7.west);
